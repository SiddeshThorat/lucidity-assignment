...
export const PencilIcon = ({ isDisabled }: { isDisabled: boolean }) => {
...
export const EyeIcon = ({ isDisabled }: { isDisabled: boolean }) => {
...
export const DeleteIcon = ({ isDisabled }: { isDisabled: boolean }) => {
